  ...
  <div class="workflow-canvas">
    ...
    <div class="main-content">
      ...
      <div class="canvas" ref="canvasRef">
        ...
        <!-- Shapes Layer -->
        <DraggableShape v-for="shape in shapes" :key="shape.id" :ref="(el) => setShapeRef(shape.id, el)" :id="shape.id"
          :initial-x="shape.position.x" :initial-y="shape.position.y" :label="shape.label" :width="shape.style.width"
          :height="shape.style.height" :shape-geometry="shape.geometry || 'rectangle'"
