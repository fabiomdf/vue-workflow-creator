<template>
  <div class="shape-selector">
    ...
    <div class="shape-grid">
      <div 
        v-for="shapeConfig in filteredShapes" 
        :key="shapeConfig.type"
        class="shape-item"
        :title="shapeConfig.description"
        @click="selectShape(shapeConfig.type)"
      >
        <!-- Shape Preview -->
        <div class="shape-preview">
          <ShapeRenderer 
            ...
            :width="40"
            :height="30"
            :background-color="shapeConfig.backgroundColor"
            :border-color="shapeConfig.borderColor"
            :border-radius="4"
          />
        </div>
